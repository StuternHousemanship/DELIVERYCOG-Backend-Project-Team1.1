            ...
            'application/json': {
                schema: {
                    ...
                    properties: {
                        ...
                        phoneNumber: {
                            type: 'string',
                            description: 'mobile phone number of the user, must be 11 digit ',
                            example: '08161228946',
                        },
                        password: {
                            type: 'string',
...
const authRouteDoc = {
    '/api/v1/auth/register': {
        post: Object.assign({}, createUser),
    },
    '/api/v1/auth/account-activation': {
        post: Object.assign({}, verifyAccount),
    },
    '/api/v1/auth/login': {
        post: Object.assign({}, signInUser),
    },
};
exports.default = authRouteDoc;
